...
- Live reset, install, cluster, router, and remote-host mutations require explicit current-session authorization. The 2026-08-09 and 2026-08-14 inspections were explicitly read-only and changed no cluster resource.
